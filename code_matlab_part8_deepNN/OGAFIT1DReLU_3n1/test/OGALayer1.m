function [errL2, parameters, uk] = OGALayer1(nNeuron, degree, pde, interval, quadInterval)
...
for k = 1 : nNeuron
    ...
    start_time = clock;
    square = [-2,2];
    theta = optimalBasisLayer1(xqd,wei,square,auxInfo,h);
