function theta = optimalBasis(qdpts,wei,square,auxInfo,h)
...
intervals = auxInfo.quadRectangle;
% intervals = 500;
...
w = w;% ./ norm2;
A = [w,b];
B = [auxInfo.preLayer(qdpts);ones(1,size(qdpts,2))];
