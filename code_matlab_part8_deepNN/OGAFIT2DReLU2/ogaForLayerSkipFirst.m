function [errL2, parameters, uk, Net] = ogaForLayerSkipFirst(Net, degree, pde, rectangle, quadRectangle)
...
if layer == 0
    ...
    innerParam = FibonacciLattices(trainingSteps);
    W1 = innerParam(:,1:inputDim);
    Bias = innerParam(:,end);
